...
QT_MOC_LITERAL(1, 11, 17), // "changeStateSignal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 30), // "std::vector<std::vector<int> >"
QT_MOC_LITERAL(4, 61, 15) // "changeStateSlot"

    },
    "GameWidget\0changeStateSignal\0\0"
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeStateSignal((*reinterpret_cast< std::vector<std::vector<int> >(*)>(_a[1]))); break;
        case 1: _t->changeStateSlot((*reinterpret_cast< std::vector<std::vector<int> >(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameWidget::*)(std::vector<std::vector<int>> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::changeStateSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::changeStateSignal(std::vector<std::vector<int>> _t1)
{
